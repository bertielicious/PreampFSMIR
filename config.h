...
/******************RC5 Global variables and #defines*/
/********States**********/
#define STARTIR 0
#define MID1 1
#define START1 2
...
#define IR  PORTBbits.RB5               // IR receiver input pin 12 RB5
/************global variables********/
...
unsigned int stateRC5 = MID1;
int enable_run = 1;
volatile unsigned int RC5_code = 0x0000;
volatile int bits = 14;        // number of bits to be shifted left to form the RC5_code (14 bits)
...
volatile bool ACW_Flag = LO;     // ACW_Flag is set when rotary encoder is turned anti-clockwise
 ...
 int current_state = STREAM;
 int temp_state = 0;
 int time_out = 0;  // if time_out = 1, 85 ms has expired
 volatile unsigned char count = 0;
 volatile unsigned char up_down = 0;
